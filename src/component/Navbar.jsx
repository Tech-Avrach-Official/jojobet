              ...
              <div className="flex items-center justify-end py-3">
                ...
                <div className="flex flex-row gap-4 px-5  border-r-2 border-gray-600">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center text-white text-sm  font-semibold py-2"
                  >
                    LOG IN
                  </button>
                </div>
            ...
            <div>
              <div className="flex items-center justify-end py-2">
                ...
                <div className="flex flex-row">
                  <button 
                    onClick={handleLoginClick}
                    className="mx-2 flex items-center justify-center text-white text-sm  font-semibold py-2"
                  >
                    LOG IN
                  </button>
                  <Link to="/register">
