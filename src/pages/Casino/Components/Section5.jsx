...
import img23 from '@/assets/gameImages/33.png';
import img24 from '@/assets/gameImages/54.jpg';
import img25 from '@/assets/gameImages/15.jpg';
import img26 from '@/assets/gameImages/6.jpg';
import img27 from '@/assets/gameImages/56.jpg';
import img49 from '@/assets/gameImages/1.jpg';
  ...
  return (
    <div className="h-auto lg:p-8 md:p-8 p-4 bg-[#1e1e20] text-white">
      <div className="flex justify-between items-center mb-4 ">
       <Link>
        <h1 className="text-xl md:text-2xl font-bold ml-4 hover:text-yellow-500">Turnuva Oyunları</h1>
        </Link>
