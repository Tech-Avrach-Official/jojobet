...
import img22 from '@/assets/gameImages/42.jpg';
...
import img51 from '@/assets/gameImages/7.jpg';
  ...
  return (
    <div className="h-auto lg:p-8 md:p-8 p-4 bg-[#1e1e20] text-white">
      <div className="flex justify-between items-center mb-4 ">
       <Link>
        <h1 className="text-xl md:text-2xl font-bold ml-4 hover:text-yellow-500">FREESPIN SATIN AL</h1>
        </Link>
