...
import img23 from '@/assets/gameImages/43.png';
import img24 from '@/assets/gameImages/44.jpg';
...
import img54 from '@/assets/gameImages/14.jpg';
  ...
  return (
    <div className="h-auto lg:p-8 md:p-8 p-4 bg-[#1e1e20] text-white">
      <div className="flex justify-between items-center mb-4 ">
       <Link>
        <h1 className="text-xl md:text-2xl font-bold ml-4 hover:text-yellow-500">Yeni Oyunlar</h1>
        </Link>
