...
//       id: 4,
//       image: card4,
//       title: "Join the Fugaso provider’s tournament with 32.900.000₺ prize money in selected games!",
//       buttonText: "MORE INFO"
//     },
//     {
//       id: 5,
//       image: card5,
//       title: "Join the $100,000 Omaha 4 Card Poker Classic Tournament exclusive to Jojobet now!",
//       buttonText: "MORE INFO"
//     },
//     {
//       id: 6,
//       image: card6,
//       title: "The opportunity to earn a daily discount for all live casino and casino games is only at Jojobet.",
//       buttonText: "MORE INFO"
//     },
//     {
//       id: 7,
...
//       id: 10,
//       image: card10,
//       title: "Join Playson’s tournament with 210.000.000₺ prize money for selected games!",
//       buttonText: "MORE INFO"
//     },
//     {
//       id: 11,
//       image: card11,
//       title: "Join the weekly Slot Tournament with 35.000.000₺ prize money exclusive to Jojobet now!",
//       buttonText: "MORE INFO"
//     },
//     {
//       id: 12,
//       image: card12,
//       title: "Join the 480,000,000₺ tournament with prizes across all games from provider Spinomenal now!",
//       buttonText: "MORE INFO"
//     },
//     {
//       id: 13,
...
//       id: 14,
//       image: card14,
//       title: "Activate SMS Authentication to make your account more secure, and get Sweet Bonanza 20 Freespins as a gift after activation!",
//       buttonText: "MORE INFO"
//     },
//     {
//       id: 15,
...
//           >
//             <div className="w-full h-54  overflow-hidden relative">
...
//             </div>
//             <div className="p-4">
//               <p className="text-sm pt-4 font-normal mb-4">{promo.title}</p>
...
const PromotionsGrid = () => {
  ...
  return (
    <div className="bg-[#1e1e20] text-white p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {promotions.map(promo => (
          <div key={promo.id} className="bg-[#1e1e20] overflow-hidden border border-opacity-20 border-white flex flex-col">
            {/* Fixed height image container */}
            <div className="w-full h-60 overflow-hidden relative">
              {/* Dark overlay effect */}
              <div className="absolute inset-0 bg-black opacity-20"></div>
              {/* Actual image with fixed height */}
              <img 
                src={promo.image} 
                alt={promo.title} 
                className="w-full h-full object-cover"
            ...
            <div className="p-6 pb-0 flex flex-col h-44">
              {/* Title with limited height and overflow */}
              <p className="text-sm pt-4 font-normal mb-2 line-clamp-3">{promo.title}</p>
